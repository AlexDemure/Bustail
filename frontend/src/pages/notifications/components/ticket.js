    ...
    render() {
        ...
        return (
                <div className="ticket__notification">
                    ...
                    <p id='from' className="ticket__notification__city from"><span>от</span> {this.props.ticket.to_go_from}</p>
                    <p id="to" className="ticket__notification__city to"><span>куда</span> {this.props.ticket.to_go_to}</p>
