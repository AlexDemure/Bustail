        ...
        return (
            <React.Fragment>
                ...
                <form className="cabinet__driver__form__driver-info" onSubmit={props.onSubmit} autoComplete="off">
                    <DefaultInput value={props.driver ? props.driver.inn : null} name="inn"  input_type="text" size="25" minLength={10} maxLength={12} placeholder="ИНН" pattern={"[0-9]+"}/>
                    ...
                    <DefaultInput value={props.driver ? props.driver.license_number : null} name="license_number" input_type="text" size="25" placeholder="Номер лицензии" isRequired={false} parser="combine"/>
