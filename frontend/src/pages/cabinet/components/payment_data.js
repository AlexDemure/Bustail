        ...
        return (
            <div className="cabinet__driver__payment-data">
                ...
                <div className="cabinet__driver__payment-data__debt-amount">
                    <p className="cabinet__driver__payment-data__item__number">{this.props.debt}</p>
                ...
                <div className="cabinet__driver__payment-data__commission-amount">
                    <p className="cabinet__driver__payment-data__item__number">{this.props.commission}</p>
                ...
                <div className="cabinet__driver__payment-data__limit-amount">
                    <p className="cabinet__driver__payment-data__item__number">{this.props.limit}</p>
