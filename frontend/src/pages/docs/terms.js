        ...
        return (
            <React.Fragment>
                ...
                <div className="docs page">
                    ...
                    <br/>8. Вознаграждения сервису
                    <br/>Перевозчики которые оказывает услуги по предложениям клиентов в качестве благодарности по собственному желанию могут сделать вознаграждение в Bustail за оказание услуг через Bustail с помощью формы оплаты в Личном кабинете перевозчика.
                    Сумма вознаграждения определяется фиксированной ставкой за оказание услуги.
